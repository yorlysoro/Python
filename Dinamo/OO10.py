class Property:
	...
	def display(self):
		print("""
				...
				bedrooms: {1}
				bathrooms: {2}
		""", format(self.square_feet, self.num_bedrooms, self.num_baths))
	def prompt_init():
...
class Apartment(Property):
	...
	def display(self):
		...
		while balcony.lower() not in Apartment.valid_balconies:
			balcony = input("Does the property have balcony? "
	...
	def prompt_init():
		...
		balcony = get_valid_input("Does the property have balcony? ",
